...
|------------|-----------|--------|--------|
| **Lecture 1 (Mon)** | 1 hrs | ORCHESTRA, define an equilibrium system, use the Notebook Template | Presentation + examples |
| **Tutorial 1** | 3 hrs | Practice with template and Orchestra | Guided group exercises + discussion |
| **Self-study (mid-week)** | 3 hrs | Reading Ch. 5 + practice | Reading & problems |
| **Lecture 2 (Thu)** | 1 hrs | Real world examples, natural water chemistry | Interactive lecture |
| **Tutorial 2** | 3 hrs | Assignments & weekly test | Group Exercises + discussion, online formative test |
| **Self-study (weekend)** | 3 hrs | Preparation for week 6 + reflection | Study, Practice & Review |

---

## 🧠 Lecture 1 (???): Chemical Equilibria Foundations
